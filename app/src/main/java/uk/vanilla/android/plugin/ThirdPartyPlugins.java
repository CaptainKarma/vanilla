package uk.vanilla.android.plugin;

import static uk.vanilla.android.plugin.ThirdParty.nuberu_url;
...
import uk.vanilla.android.vanilla.FileUtils;
import uk.vanilla.android.vanilla.MediaUtils;
import uk.vanilla.android.vanilla.PlaybackService;
import uk.vanilla.android.vanilla.PrefDefaults;
import uk.vanilla.android.vanilla.PrefKeys;
import uk.vanilla.android.vanilla.QueryTask;
import uk.vanilla.android.vanilla.R;
import uk.vanilla.android.vanilla.SharedPrefHelper;
import uk.vanilla.android.vanilla.Song;
import uk.vanilla.android.vanilla.SongTimeline;
...
public class ThirdPartyPlugins {
	...
	public void request_track_from_seed_track(String seed_track) {
		...
		long track_duration_secs = PlaybackService.get(mContext).getDuration() / 1000;
		Log.d("VanillaICE", "## Track Duration:" + track_duration_secs);
