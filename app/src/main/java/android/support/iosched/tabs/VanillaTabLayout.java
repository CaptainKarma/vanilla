...
public class VanillaTabLayout extends SlidingTabLayout {
	...
	public VanillaTabLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		setSelectedIndicatorColors(context.getResources().getColor(uk.vanilla.android.vanilla.R.color.tabs_active_indicator));
	...
	protected TextView createDefaultTabView(Context context) {
		...
		view.setTextColor(getResources().getColorStateList(uk.vanilla.android.vanilla.R.color.tab_text_selector));
		view.setBackgroundResource(uk.vanilla.android.vanilla.R.drawable.unbound_ripple_light);
		view.setMaxLines(1);
